...
\begin{cventries}
    \cventry
        ...
        {
            \begin{cvitems}
                \item {Design and development of an app for the infotainment stack for a Linux-based OS in the automotive industry.}
                \item {Implemented and maintained a CI/CD pipeline and related processes.}
                \item {Tools used for daily activities: Linux, C/C++, Bash, Jenkins, Docker, git, GitHub.}
            \end{cvitems}
        }
    \cventry
